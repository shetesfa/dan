...
$templates_query = "SELECT * FROM product_templates 
...
<head>
    ...
    <title><?php echo htmlspecialchars($product['title']); ?> Design Templates | Dan Creatives</title>
...
<section class="templates-hero">
    <div class="container">
        <h1><?php echo htmlspecialchars($product['title']); ?> <span>Design Templates</span></h1>
        <p>Browse our collection of design styles and choose your favorite for <?php echo htmlspecialchars($product['title']); ?></p>
...
<section class="templates-section">
    <div class="container">
        ...
        <div class="templates-grid">
            ...
            <div class="template-card">
                ...
                <div class="template-info">
                    ...
                    <button class="btn-choose" onclick="openOrderModal(<?php echo $template['id']; ?>, '<?php echo addslashes($template['title']); ?>', '<?php echo addslashes($template['image_url']); ?>', <?php echo $product_id; ?>, '<?php echo addslashes($product['title']); ?>')">
        ...
        <div class="no-templates" style="text-align: center; padding: 60px; background: white; border-radius: 20px;">
            ...
            <h3 style="margin-top: 20px;">No Design Templates Available Yet</h3>
            <p>Check back soon for design templates!</p>
            <a href="products.php" class="btn-choose" style="display: inline-block; width: auto; margin-top: 20px;">Back to Products</a>
        </div>
        <?php endif; ?>
    </div>
</section>
...
<div id="orderModal" class="order-modal">
    <div class="modal-container">
        <div class="modal-header">
            <h3><i class="fas fa-shopping-cart"></i> Order This Design</h3>
        ...
        <div class="modal-body">
            <div class="template-preview" id="templatePreview">
                ...
                <div>
                    ...
                    <p id="previewProduct">Product Name</p>
                </div>
            </div>
            ...
            <form id="orderForm" onsubmit="return false;">
                ...
                <div class="form-group-modal">
                    ...
                    <input type="email" id="customer_email" placeholder="We'll send order confirmation (optional)">
                </div>
                <div class="form-group-modal">
...
function openOrderModal(templateId, templateTitle, templateImage, productId, productTitle) {
    document.getElementById('previewImage').src = templateImage;
    document.getElementById('previewTitle').innerHTML = templateTitle;
    document.getElementById('previewProduct').innerHTML = productTitle;
