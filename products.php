...
$products_query = "SELECT * FROM products WHERE status = 'active' ORDER BY display_order ASC, id DESC";
...
<head>
    ...
    <title>Our Products | Dan Creatives</title>
...
<section class="products-hero">
    <div class="container">
        ...
        <p>High-quality custom products designed to make your brand stand out - Click any product to see our designs</p>
    </div>
</section>
...
<section class="products-section">
    <div class="container">
        <div class="section-header">
            ...
            <p>Custom designed products for your brand and personal use - Click to see design options</p>
        </div>
        <div class="products-grid">
            <?php while($product = $products->fetch_assoc()): ?>
            <div class="product-card" onclick="window.location.href='product-portfolio.php?product_id=<?php echo $product['id']; ?>'">
