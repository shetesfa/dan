...
$sql = "INSERT INTO product_orders (product_id, product_name, customer_name, customer_email, customer_phone, customer_telegram, quantity, size, color, message, status, created_at) 
        VALUES ($product_id, '$product_name', '$customer_name', '$customer_email', '$customer_phone', '$customer_telegram', '$quantity', '$size', '$color', '$requirements', 'pending', NOW())";
...
if ($conn->query($sql)) {
    ...
    $message .= "#ProductOrder #{$product_name}";
